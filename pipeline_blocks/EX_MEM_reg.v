module EX_MEM_reg(
    ...
    //  Control signals IN 
    input        in_MemRead, in_MemWrite, in_MemtoReg, in_RegWrite,
    input        in_SLT, in_HiLoWrite,

    // Data going IN 
    input [31:0] in_ALU_Hi, in_ALU_Lo,
    input        in_Zero, in_Sign,
    input [31:0] in_Write_Data,   // forwarded RD2 (used by SW)
    input [4:0]  in_Write_Reg,

    //  Control signals OUT
    output reg        out_MemRead, out_MemWrite, out_MemtoReg, out_RegWrite,
    output reg        out_SLT, out_HiLoWrite,

    //  Data going OUT 
    output reg [31:0] out_ALU_Hi, out_ALU_Lo,
    output reg        out_Zero, out_Sign,
    ...
    always @(posedge clk) begin
        ...
        out_Zero      <= in_Zero;      out_Sign      <= in_Sign;
